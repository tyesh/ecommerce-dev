...
export const AUTHOR_LIST_ALL_REQUEST = 'AUTHOR_LIST_ALL_REQUEST';
export const AUTHOR_LIST_ALL_SUCCESS = 'AUTHOR_LIST_ALL_SUCCESS';
export const AUTHOR_LIST_ALL_FAIL = 'AUTHOR_LIST_ALL_FAIL';
