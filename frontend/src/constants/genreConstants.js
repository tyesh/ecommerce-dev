...
export const GENRE_LIST_ALL_REQUEST = 'GENRE_LIST_ALL_REQUEST';
export const GENRE_LIST_ALL_SUCCESS = 'GENRE_LIST_ALL_SUCCESS';
export const GENRE_LIST_ALL_FAIL = 'GENRE_LIST_ALL_FAIL';
